...
export const metadata = {
  title: "Terms of Service - GENGRAPHS AND GRAPHICS PVT LTD®",
  description: "Terms and conditions regulating premium dashboards, mockups, design licensing, and support agreements.",
};
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col items-center text-center mb-16">
            ...
            <p className="max-w-xl text-xs sm:text-sm text-muted-foreground leading-relaxed">
              Rules, guidelines, and definitions governing downloaded Power BI assets and design commissions.
            </p>
          </div>
          ...
          <div className="space-y-8">
            <section className="rounded-3xl bg-card/60 border border-border/80 p-6 sm:p-8 backdrop-blur-xl shadow-sm">
              ...
              <div className="space-y-6 text-xs text-muted-foreground leading-relaxed font-sans">
                <p>
                  GENGRAPHS AND GRAPHICS grants users a commercial, non-exclusive, non-transferable license to deploy our templates within internal corporate networks. Custom design solutions are governed by their respective Statements of Work.
                </p>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                  <div className="p-4 rounded-2xl bg-card border border-border/40 space-y-2">
                    <h3 className="text-xs font-bold text-foreground">Copyright Bounds</h3>
                    <p className="text-[11px] text-muted-foreground/80">
                      All templates, layout visuals, grids, mockups, and DAX frameworks are copyrighted intellectual assets.
                    </p>
                  </div>
                  <div className="p-4 rounded-2xl bg-card border border-border/40 space-y-2">
                    <h3 className="text-xs font-bold text-foreground">Account Responsibilities</h3>
                    <p className="text-[11px] text-muted-foreground/80">
                      Users must secure authorization credentials and are fully responsible for all downloads originating from their profile.
                    </p>
                  </div>
                </div>

                <p className="pt-4 text-xs italic">
                  Additional Terms of Service will be integrated when requested.
                </p>
              </div>
            </section>
          </div>
